    ...
    <x-container x-data="{ loader: false }" class="mt-6 sm:mt-10">
        ...
        >
            ...
            <button 
                ...
                wire:click="setConsole({{ $console['id'] }})" class="z-40 group flex cursor-pointer sepia_ {{ $selected_console_id !== $console['id'] ? '' : 'bg-cod-gray-600/20 rounded-t-lg md:rounded-t-xl' }} px-4 py-2 xl:py-6 items-center justify-center w-full text-xl md:text-2xl overflow-hidden">

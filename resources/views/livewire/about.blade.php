    ...
    <x-container class=" text-cod-gray-600 dark:text-cod-gray-500 mt-6">
        <div class="flex flex-col gap-y-[5rem] lg:flex-row lg:gap-x-[5rem]">
            <div class="flex flex-col gap-y-4 leading-tight">
                ...
                <p>I'm a passionate web developer and gamer, and I'm thrilled to share my latest project with you. <span class=" text-cod-gray-900 dark:text-cod-gray-300">"Vintage Game Consoles"</span> is a full-stack web app that allows you to play lots of vintage console games right in your browser.</p>
                ...
                <p>I'm still under development, but I'm excited to continue working on <span class=" text-cod-gray-900 dark:text-cod-gray-300">"Vintage Game Consoles"</span> and adding new features and improvements. I encourage you to check it out and let me know what you think!</p>
            </div>
